...
public class ResenaController {
    ...
    @Operation(summary = "Crear una nueva reseña", description = "Registra una nueva reseña asociada a un cliente y producto, validando la existencia de ambos a través de los microservicios remotos.")
    @ApiResponses({
    ...
    @Operation(summary = "Obtener reseña por ID", description = "Busca una reseña específica por su ID.")
    @ApiResponses({
        @ApiResponse(responseCode = "200", description = "Reseña encontrada"),
        @ApiResponse(responseCode = "404", description = "Reseña no encontrada")
    })
    @GetMapping("/{id}")
    public ResponseEntity<ResenaDTO> obtenerPorId(@PathVariable @Parameter(description = "ID de la reseña", example = "1") Long id) {
        log.info("Petición REST [GET /resenas/{}] recibida", id);
        ResenaDTO resena = resenaService.obtenerPorId(id);
        return ResponseEntity.ok(resena);
    }

    @Operation(summary = "Obtener reseñas por ID de cliente", description = "Filtra y retorna las reseñas realizadas por un cliente específico.")
    @ApiResponses({
    ...
    public ResponseEntity<List<ResenaDTO>> obtenerPorCliente(@PathVariable @Parameter(description = "ID del cliente", example = "1") Long clienteId) {
    ...
    @Operation(summary = "Obtener reseñas por ID de producto", description = "Filtra y retorna las reseñas de un producto específico.")
    @ApiResponses({
    ...
    public ResponseEntity<List<ResenaDTO>> obtenerPorProducto(@PathVariable @Parameter(description = "ID del producto", example = "1") Long productoId) {
    ...
    @Operation(summary = "Obtener reseñas aprobadas de un producto", description = "Retorna únicamente las reseñas aprobadas de un producto específico.")
    @ApiResponses({
    ...
    public ResponseEntity<List<ResenaDTO>> obtenerAprobadasPorProducto(@PathVariable @Parameter(description = "ID del producto", example = "1") Long productoId) {
    ...
    @Operation(summary = "Obtener reseñas por estado", description = "Filtra reseñas según su estado (PENDIENTE, APROBADA, RECHAZADA).")
    @ApiResponses({
    ...
    public ResponseEntity<List<ResenaDTO>> obtenerPorEstado(@PathVariable @Parameter(description = "Estado de la reseña (PENDIENTE, APROBADA, RECHAZADA)", example = "APROBADA") EstadoResena estado) {
    ...
    public ResponseEntity<ResenaDTO> actualizarResena(
            @PathVariable @Parameter(description = "ID de la reseña", example = "1") Long id,
    ...
    @Operation(summary = "Actualizar estado de una reseña", description = "Cambia el estado de una reseña (aprobar, rechazar, etc.).")
    @ApiResponses({
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> eliminarResena(@PathVariable @Parameter(description = "ID de la reseña", example = "1") Long id) {
        log.info("Petición REST [DELETE /resenas/{}] recibida para ELIMINAR reseña", id);
        resenaService.eliminarResena(id);
        return ResponseEntity.noContent().build();
    }

    @Operation(summary = "Agregar respuesta a una reseña", description = "Agrega una respuesta del vendedor o administrador a una reseña existente.")
    @ApiResponses({
    ...
    public ResponseEntity<RespuestaResenaDTO> agregarRespuesta(
            @PathVariable @Parameter(description = "ID de la reseña", example = "1") Long resenaId,
    ...
    @Operation(summary = "Obtener respuestas de una reseña", description = "Obtiene todas las respuestas asociadas a una reseña.")
    @ApiResponses({
    ...
    public ResponseEntity<List<RespuestaResenaDTO>> obtenerRespuestas(@PathVariable @Parameter(description = "ID de la reseña", example = "1") Long resenaId) {
    ...
    @Operation(summary = "Obtener resumen de reseñas de un producto", description = "Obtiene el resumen estadístico de reseñas de un producto (promedio, cantidad, distribución por estrellas).")
    @ApiResponses({
        @ApiResponse(responseCode = "200", description = "Resumen obtenido exitosamente"),
        @ApiResponse(responseCode = "404", description = "Producto no encontrado")
    })
    @GetMapping("/producto/{productoId}/resumen")
    public ResponseEntity<Map<String, Object>> obtenerResumenProducto(@PathVariable @Parameter(description = "ID del producto", example = "1") Long productoId) {
    ...
    @Operation(summary = "Obtener resumen de reseñas de un cliente", description = "Obtiene el resumen de reseñas de un cliente (cantidad de reseñas, valoraciones hechas).")
    @ApiResponses({
        @ApiResponse(responseCode = "200", description = "Resumen obtenido exitosamente"),
        @ApiResponse(responseCode = "404", description = "Cliente no encontrado")
    })
    @GetMapping("/cliente/{clienteId}/resumen")
    public ResponseEntity<Map<String, Object>> obtenerResumenCliente(@PathVariable @Parameter(description = "ID del cliente", example = "1") Long clienteId) {
